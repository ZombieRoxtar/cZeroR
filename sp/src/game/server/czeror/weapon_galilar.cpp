...
//
// Purpose: Galil AR Weapon, replaces IDF Defender
//
//=============================================================================
#include "cbase.h"
...
class CWeaponGalilAR : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponGalilAR, CBaseAdvancedWeapon );
		DECLARE_NETWORKCLASS();
		DECLARE_PREDICTABLE();

		float GetFireRate() { return 0.09009009009009009009009009009009f; } // 666 Rounds per minute

		DECLARE_ACTTABLE();
};

IMPLEMENT_SERVERCLASS_ST( CWeaponGalilAR, DT_WeaponGalilAR )
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_galilar, CWeaponGalilAR );
PRECACHE_WEAPON_REGISTER( weapon_galilar );

acttable_t CWeaponGalilAR::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE( CWeaponGalilAR );