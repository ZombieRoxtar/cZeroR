...
class CWeaponAWP : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponAWP, CBaseAdvancedWeapon );
		DECLARE_NETWORKCLASS();
		DECLARE_PREDICTABLE();

		float GetFireRate() { return 1.4634146341463414634146341463415f; } // 41 Rounds per minute
