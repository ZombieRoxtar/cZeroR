...
class CWeaponSawedOff : public CBaseAdvancedWeapon
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS( CWeaponSawedOff, CBaseAdvancedWeapon );
	DECLARE_SERVERCLASS();
	...
	virtual float GetFireRate() { return 0.8450704225352112676056338028169f; } // 71 RPM
...
//-----------------------------------------------------------------------------
bool CWeaponSawedOff::StartReload( void )
{
...
bool CWeaponSawedOff::Reload( void )
{
	...
	if ( !m_bInReload )
	{
		Warning( "ERROR: Sawed-Off Reload called incorrectly!\n" );
	}
...
//-----------------------------------------------------------------------------
void CWeaponSawedOff::FinishReload( void )
{
...
//-----------------------------------------------------------------------------
void CWeaponSawedOff::FillClip( void )
{
	CBaseCombatCharacter *pOwner = GetOwner();
