...
//
// Purpose: Heckler & Koch P2000, replaces the KM .45 "CT-Spawn Gun"
//
//=============================================================================
#include "cbase.h"
...
class CWeaponHKP2000 : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponHKP2000, CBaseAdvancedWeapon );
		DECLARE_NETWORKCLASS();
		DECLARE_PREDICTABLE();

		float GetFireRate() { return 0.17045454545454545454545454545455f; } // 352 RPM

		DECLARE_ACTTABLE();
};

IMPLEMENT_SERVERCLASS_ST( CWeaponHKP2000, DT_WeaponHKP2000 )
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_hkp2000, CWeaponHKP2000 );
PRECACHE_WEAPON_REGISTER( weapon_hkp2000 );

acttable_t CWeaponHKP2000::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE( CWeaponHKP2000 );