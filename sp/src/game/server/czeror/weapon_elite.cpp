...
//
// Purpose: Dual Beretta Weapon, Dual Elites, Dualies!
//
//=============================================================================
#include "cbase.h"
...
class CWeaponElite : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponElite, CBaseAdvancedWeapon );
		DECLARE_NETWORKCLASS();
		DECLARE_PREDICTABLE();

		float GetFireRate() { return 0.12f; } // 500 Rounds per minute in CS:GO
