...
class CWeaponM4A4 : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponM4A4, CBaseAdvancedWeapon );
...
IMPLEMENT_SERVERCLASS_ST( CWeaponM4A4, DT_WeaponM4A4 )
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_m4a4, CWeaponM4A4 );
PRECACHE_WEAPON_REGISTER( weapon_m4a4 );

acttable_t CWeaponM4A4::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE( CWeaponM4A4 );
