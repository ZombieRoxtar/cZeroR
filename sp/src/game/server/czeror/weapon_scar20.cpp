...
//
// Purpose: Scar-20 Weapon, replaces Krieg 550 Commando
//
//=============================================================================
#include "cbase.h"
...
// CWeaponScar20
//-----------------------------------------------------------------------------
class CWeaponScar20 : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponScar20, CBaseAdvancedWeapon);
...
IMPLEMENT_SERVERCLASS_ST( CWeaponScar20, DT_WeaponScar20 )
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_scar20, CWeaponScar20 );
PRECACHE_WEAPON_REGISTER( weapon_scar20 );

acttable_t CWeaponScar20::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE( CWeaponScar20 );