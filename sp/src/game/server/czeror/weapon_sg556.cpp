...
//
// Purpose: SG556, replaces Krieg 552
//
//=============================================================================
#include "cbase.h"
...
// CWeaponSG556
//-----------------------------------------------------------------------------
class CWeaponSG556 : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponSG556, CBaseAdvancedWeapon);
		DECLARE_NETWORKCLASS();
		DECLARE_PREDICTABLE();
		DECLARE_ACTTABLE();

		float GetFireRate() { return 0.09009009009009009009009009009009f; } // 666 RPM
};

IMPLEMENT_SERVERCLASS_ST( CWeaponSG556, DT_WeaponSG556 )
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_sg556, CWeaponSG556 );
PRECACHE_WEAPON_REGISTER( weapon_sg556 );

acttable_t CWeaponSG556::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE( CWeaponSG556 );