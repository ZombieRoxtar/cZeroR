...
//
// Purpose: SSG08, replaces Schmidt Scout
//
//=============================================================================
#include "cbase.h"
...
// CWeaponSSG08
//-----------------------------------------------------------------------------
class CWeaponSSG08 : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponSSG08, CBaseAdvancedWeapon);
		DECLARE_NETWORKCLASS();
		DECLARE_PREDICTABLE();
		DECLARE_ACTTABLE();

		float GetFireRate() { return 1.25; } // 48 RPM
};

IMPLEMENT_SERVERCLASS_ST( CWeaponSSG08, DT_WeaponSSG08 )
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_ssg08, CWeaponSSG08 );
PRECACHE_WEAPON_REGISTER( weapon_ssg08 );

acttable_t CWeaponSSG08::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE( CWeaponSSG08 );