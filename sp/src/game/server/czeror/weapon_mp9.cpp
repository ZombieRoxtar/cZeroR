...
//
// Purpose: MP9 Weapon, replaces TMP
//
//=============================================================================
#include "cbase.h"
...
// CWeaponMP9
//-----------------------------------------------------------------------------
class CWeaponMP9 : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponMP9, CBaseAdvancedWeapon );
...
IMPLEMENT_SERVERCLASS_ST( CWeaponMP9, DT_WeaponMP9 )
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_mp9, CWeaponMP9 );
PRECACHE_WEAPON_REGISTER( weapon_mp9 );

acttable_t CWeaponMP9::m_acttable[] =
{
