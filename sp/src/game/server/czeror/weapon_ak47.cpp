...
class CWeaponAK47 : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponAK47, CBaseAdvancedWeapon );
		DECLARE_NETWORKCLASS();
		DECLARE_PREDICTABLE();

		float GetFireRate() { return 0.1f; } // 600 Rounds per minute
