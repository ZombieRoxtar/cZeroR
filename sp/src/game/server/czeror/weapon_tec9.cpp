...
class CWeaponTec9 : public CBaseAdvancedWeapon
{
	public:
		DECLARE_CLASS( CWeaponTec9, CBaseAdvancedWeapon );
		DECLARE_NETWORKCLASS();
		DECLARE_PREDICTABLE();

		float GetFireRate() { return 0.12f; } // 500 RPM

		DECLARE_ACTTABLE();
};

IMPLEMENT_SERVERCLASS_ST( CWeaponTec9, DT_WeaponTec9 )
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS( weapon_tec9, CWeaponTec9 );
PRECACHE_WEAPON_REGISTER( weapon_tec9 );

acttable_t CWeaponTec9::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE( CWeaponTec9 );